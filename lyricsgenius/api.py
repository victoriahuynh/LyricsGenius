...
class Genius(API):
    ...
    def _result_is_lyrics(self, song_title):
        ...
        default_terms = ['track\\s?list', 'album art(work)?', 'liner notes',
                         ...
                         'instrumental', 'born','forever boy', 'blessed', 'lady money', 'attends-moi', 'baby loves', 'breaking you', 'remix', "Edit", "translation", "Version", "Cover", "Demo", "Live", "Oversat", "Visual", "Quotes", "Meaning", "Medley", "Intro", "Radio"]
